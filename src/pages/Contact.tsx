              ...
              <div className="bg-card rounded-2xl border border-border p-8 h-full">
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  <div>
                    ...
                    <input type="text" required maxLength={100} value={contactForm.name} onChange={e => setContactForm(p => ({ ...p, name: e.target.value }))}
                  ...
                  <div>
                    ...
                    <input type="email" required maxLength={255} value={contactForm.email} onChange={e => setContactForm(p => ({ ...p, email: e.target.value }))}
                      className="w-full px-4 py-3 rounded-lg border border-input bg-background text-foreground focus:ring-2 focus:ring-primary focus:outline-none" />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-foreground mb-1 block">{t('contact.form.message')}</label>
                    <textarea required maxLength={1000} rows={4} value={contactForm.message} onChange={e => setContactForm(p => ({ ...p, message: e.target.value }))}
